                ...
                dataRepo.getAllPersons().stream().map( person -> {
                            ...
                            if(person.getPersonStatus() == PersonStatus.ACTIVE) {
                                em.add(linkTo(methodOn(PersonController.class).deletePerson(person.getId())).withRel("delete"),
                                        linkTo(methodOn(PersonController.class).hirePerson(person.getId())).withRel("hire"),
                                        linkTo(methodOn(PersonController.class).deactivatePerson(person.getId())).withRel("deactivate"));
                            } else if(person.getPersonStatus() == PersonStatus.HIRED){
                                em.add(linkTo(methodOn(PersonController.class).vacatePerson(person.getId())).withRel("vacate"));
                            } else if (person.getPersonStatus() == PersonStatus.NOT_ACTIVE) {
                                em.add(linkTo(methodOn(PersonController.class).deletePerson(person.getId())).withRel("delete"),
                                        linkTo(methodOn(PersonController.class).activatePerson(person.getId())).withRel("activate"));
                            }
                            em.add(linkTo(methodOn(PersonController.class).getAllPersons()).withRel("list all"));
                            return em;
                        }
